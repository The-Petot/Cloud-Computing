...
import { handleUserRegister, handleUserLogin, handleTokenRefresh, handleUserLogout, handleEnableTwoFactorAuth, handleDisableTwoFactorAuth } from '../controllers/auth.controller';
const authRouter = new Elysia().post('/register', handleUserRegister, {
    detail: {
