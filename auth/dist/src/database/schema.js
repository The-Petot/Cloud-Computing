...
export const suggestionsUsersRelation = relations(suggestionsTable, ({ one })=>({
        user: one(usersTable, {
            fields: [
                suggestionsTable.userId
            ],
            references: [
                usersTable.id
            ]
...
export const challengesUsersRelation = relations(challengesTable, ({ one })=>({
        author: one(usersTable, {
            fields: [
                challengesTable.authorId
            ],
            references: [
                usersTable.id
            ]
...
export const challengesParticipantsRelation = relations(challengesTable, ({ many })=>({
        participants: many(participantsTable)
    }));
export const participantsChallengesRelation = relations(participantsTable, ({ one })=>({
        challenge: one(challengesTable, {
            fields: [
                participantsTable.challengeId
            ],
            references: [
                challengesTable.id
            ]
...
export const participantsUsersRelation = relations(participantsTable, ({ one })=>({
        user: one(usersTable, {
            fields: [
                participantsTable.participantId
            ],
            references: [
                usersTable.id
            ]
...
export const challengesQuestionsRelation = relations(challengesTable, ({ many })=>({
        questions: many(questionsTable)
    }));
export const questionsChallengesRelation = relations(questionsTable, ({ one })=>({
        challenge: one(challengesTable, {
            fields: [
                questionsTable.challengeId
            ],
            references: [
                challengesTable.id
            ]
...
export const questionsAnswersRelation = relations(questionsTable, ({ many })=>({
